/*
    Change the phiLength on a THREE.SphereGeometry
    ---
...
export default function(geometry, phiLength = Math.PI * 2) {
    ...
    let thetaLength = geometry.parameters.thetaLength || Math.PI;
