/*
    Change the thetaLength on a THREE.SphereGeometry
    ---
...
export default function(geometry, thetaLength = Math.PI) {
    ...
    let phiLength = geometry.parameters.phiLength || Math.PI * 2;
